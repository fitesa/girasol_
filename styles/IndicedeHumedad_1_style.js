...
var style_IndicedeHumedad_1 = function(feature, resolution){
    ...
    if (value >= -0.204432 && value <= -0.081154) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.081154 && value <= 0.042125) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.042125 && value <= 0.165403) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.165403 && value <= 0.288682) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.288682 && value <= 0.411961) {
            style = [ new ol.style.Style({
